...
set(LIVE555CFLAGS -DBSD=1 -DSOCKLEN_T=socklen_t -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE=1 -DNO_SSTREAM=1 -DALLOW_RTSP_SERVER_PORT_REUSE=1 -DNO_GETIFADDRS=1 -DNO_OPENSSL=1 CACHE STRING "live555 CFGLAGS")
...
target_compile_definitions(live555 PUBLIC ${LIVE555CFLAGS})

if(MSVC)
    add_definitions(-D_CRT_SECURE_NO_WARNINGS)
#    if (NOT MSVC)
#        target_link_options(live555 PRIVATE -static-libgcc -static-libstdc++ -Wl,-Bstatic,--whole-archive -lwinpthread -Wl,--no-whole-archive)
#    endif()
endif()
